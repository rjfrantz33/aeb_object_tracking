...
/// @brief Detected objects for Autonomous Emergency Braking and Collision Warning Systems (AEB/CW).
/// @details This class represents an object detected by AEB tracking system, encapsulating its
/// unique identifier, distance, relative velocity, estimated collision time,
/// and calculated threat level.
/// 
/// The threat level is computed based on object dynamics and is used to assess collision risk.
///
...
public:
    ...
    constexpr float getRelativeVelocity() const {
...
public:
    ...
    ///
    void partialSortCriticalObjects(std::size_t max_objects = kMaxCriticalObjects);
    ...
    /// making the code's intent clearer and reducing the risk of accidental misuse.
    /// 
